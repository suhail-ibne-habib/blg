...
const PostMenuActions = ({post}) => {
  ...
  return (
    <div className="">
        ...
        {
            isPending ? ("Loading ...") :
            error ? (`${ error.message } Saved post fetching error`) :
            isSignedIn && (
                ...
                <div className="flex items-center gap-2 py-2 text-sm cursor-pointer" onClick={handleSave}>
                    ...
                    >
                        <path
                            ...
                            strokeWidth="2"
                            fill={ 
                                savedMutation.isPending ? isSaved ? "none" : 'black' : isSaved ? 'black' : 'none'
                             }
                        />
                    </svg>
                    ...
                    {savedMutation.isPending && <span className='text-xs'>In Progress</span>}
